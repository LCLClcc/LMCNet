...
class ResNet(nn.Module):
    ...
    def __init__(self, block, pretrain=False, meta_test=False, drop_block=False, drop_rate=0.1, dropblock_size=5):
        self.inplanes = 3
        self.nFeat = 512
        ...
        self.layer4 = self._make_layer(block, 512, stride=2, drop_rate=drop_rate, drop_block=drop_block,
                                       block_size=dropblock_size, pool=False)  # [64, 128, 256, 512], [64, 160, 320, 640]
