...
def argument_parser():
    ...
    parser.add_argument('-j', '--workers', default=4, type=int,
                        help="number of tiered_dataloader loading workers (default: 4)")
    ...
    # Miscs
    # ************************************************************a
    parser.add_argument('--save-dir', type=str, default='./mini_final_1shot/')
    parser.add_argument('--resume', type=str, default='./Logs/', metavar='PATH')
